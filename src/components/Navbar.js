        ...
        <div className={`flex-1 pb-3 mt-8 md:block md:pb-0 md:mt-0 ${state ? 'block' : 'hidden'}`}>
          <ul className="justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
            ...
            <div className='space-y-3 items-center gap-x-6 md:flex md:space-y-0'>
              ...
              <li>
                <Link to="/signup" className="block py-3 px-4 font-medium text-center text-white bg-teal-600 hover:bg-teal-500 transition-all duration-100 ease-linear active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline">
                  Sign up
                </Link>
              </li>
            </div>
